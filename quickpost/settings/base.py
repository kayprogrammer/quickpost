...
JAZZMIN_SETTINGS = {
    ...
    "site_title": "QUICKPOST ADMIN",
    # Title on the login screen (19 chars max) (defaults to current_admin_site.site_header if absent or None)
    "site_header": "QUICKPOST",
    ...
    "welcome_sign": "Welcome to the Quickpost Admin Section",
    # Copyright on the footer
    "copyright": "Quickpost Ltd",
    # The model admin to search from the search bar, search bar omitted if excluded
    "search_model": ["accounts.User", "blog.Post"],
    ...
    "usermenu_links": [
        {"name": "QUICKPOST API DOCS", "url": "/", "new_window": True},
        {
            "name": "GITHUB REPO",
            "url": "https://github.com/kayprogrammer/quickpost",
            "new_window": True,
        },
        {"model": "accounts.user"},
    ],
